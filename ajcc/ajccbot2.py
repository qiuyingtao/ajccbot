...
lastUrlFilePath = '/home/duporg/ccdiajcc/lastUrl.txt'
lastUrlFile = open(lastUrlFilePath)
lastUrl = lastUrlFile.readline().strip('\n')
lastUrlFile.close()
...
while hasAvailableLi:
    ...
    if lastUrl != linkUrl:
        ...
        lastUrlFile = open(lastUrlFilePath, 'w')
        lastUrlFile.write(urlandtxtList[0][0])
        lastUrlFile.close()
